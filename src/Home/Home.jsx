...
const Home = () => {
  return (
    <div
      ...
      id="home"
    >
      <div className="md:pt-0 lg:w-7/12 md:h-1/2 md:w-full md:px-10 lg:px-0 ">
        <div className="flex flex-col-reverse items-center justify-between md:flex-row text-center md:text-start px-5 md:p-0">
          ...
          <div className="p-5 mt-20 md:mt-0">
            <div className="w-52 h-52 md:w-64 md:h-64 lg:w-96 lg:h-96 border-2 border-black dark:border-[var(--clr-text-light3)] overflow-hidden shape"></div>
          </div>
        </div>
